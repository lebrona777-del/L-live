...
/*
  მარტივი Admin პაროლი.
  შეგიძლია დატოვო "L".
  თუ მომავალში Vercel-ში ADMIN_PASSWORD-ს დაამატებ,
  ის ავტომატურად გამოიყენება.
*/
const ADMIN_PASSWORD =
  process.env.ADMIN_PASSWORD || "L";
...
const upload = multer({
  ...
  fileFilter: (req, file, cb) => {
    if (
      ...
      cb(
        new Error(
          "მხოლოდ სურათის ატვირთვა შეიძლება."
        )
      );
    }
  }
